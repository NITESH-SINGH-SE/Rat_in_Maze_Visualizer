...
function Maze(props) {
    ...
    return (
        ...
        <div className="w-full flex align-middle justify-center mt-4">
            <button onClick={algoRat} disabled={disableBtn} className="bg-blue-600 hover:bg-blue-700 font-semibold py-2 px-4 rounded" >Start</button>
            <button onClick={reset} disabled={disableBtn} className="bg-blue-600 ml-4 hover:bg-blue-700 font-semibold py-2 px-4 rounded" >Reset</button>
        </div>
